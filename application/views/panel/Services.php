                                        ...
                                        <table class="table table-hover table-striped table-responsive">
                                            ...
                                            <?php foreach ($services as $service): ?>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td><?php echo $service['sms_channel']; ?></td>
                                                    <td><?php echo $service['sms_channel_id']; ?></td>
                                                    <td><?php echo $service['sms_number']; ?></td>
                                                    <td><?php echo number_format(round($service['paypal_cost'], 2), 2, ',', ' '); ?> zł</td>
